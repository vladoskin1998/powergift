        ...
        <div className="card-desc">
            ...
            <div className="card-desc-info">
                ...
                <div>
                      ...
                      <p className="card-desc-info-desc-text" style={{paddingTop:'30px'}}>Пляшка виготовлена   з екологічно чистого матеріалу Tritan Eastman™ і може підтримувати температурні навантаження від -10 до +96Оптимальний розмір та об'єм пляшки максимально підходить для повсякденного використання.У комплекті є ситечко, яке дозволяє додавати у воду фрукти або заварювати чай.Стильна, якісна та практична.</p>
                </div>
            </div>
        </div>
    )
